"""Transcript cleanup helpers local to the review_canvas skill."""
...
def correct_transcript(
    ...
    for sentence in transcript["sentences"]:
        name = speaker_names.get(str(sentence["spk"]), f"说话人{sentence['spk']}")
        lines.append(f"[{name}] {sentence['text']}")
